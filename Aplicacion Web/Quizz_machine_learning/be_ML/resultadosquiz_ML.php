...
function guardar_resultado() {
    if (isset($_POST['nombre_usuario'], $_POST['puntuacion'])) {
        require_once("quiz_backend_ML.php"); // Asegúrate de tener la conexión a la base de datos
        ...
        $consulta = "INSERT INTO resultados_quiz_ML (usuario, puntuacion) VALUES ('$nombre_usuario', $puntuacion)";

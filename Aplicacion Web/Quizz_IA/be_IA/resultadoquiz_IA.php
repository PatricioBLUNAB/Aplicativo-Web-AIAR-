...
function guardar_resultado() {
    if (isset($_POST['nombre_usuario'], $_POST['puntuacion'])) {
        require_once("quiz_backend_IA.php"); // Asegúrate de tener la conexión a la base de datos
        ...
        $consulta = "INSERT INTO resultados_quiz_IA (usuario, puntuacion) VALUES ('$nombre_usuario', $puntuacion)";
